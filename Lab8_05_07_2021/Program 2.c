//C program to create student structure, read two student details( Student roll number, name, section, department, fees, and results i.e.,
//total marks obtained) and print the student details  who has scored the highest
#include<stdio.h>
struct student
{
	int rollnumber;
...
int main()
{
	...
	printf("Department of student 1 :: %s\n",stud1.dept);
	printf("Fees of student 1 :: %0.2f\n",stud1.fees);
